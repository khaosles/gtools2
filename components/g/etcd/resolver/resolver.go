...
type YhkjBuilder struct {
	client *clientv3.Client
}

func NewYhkjBuilder(client *clientv3.Client) *YhkjBuilder {
	return &YhkjBuilder{client: client}
}

func (b YhkjBuilder) Build(target gresolver.Target, cc gresolver.ClientConn, opts gresolver.BuildOptions) (gresolver.Resolver, error) {
	r := NewResolver(b.client, target.Endpoint(), cc)
	return r, nil
}

func (b YhkjBuilder) Scheme() string {
	return "yhkj"
}
